...
import { GenerationOptionsDTO } from '../../types/testCase';
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        <label className="flex items-center gap-2 text-xs text-slate-300 cursor-pointer select-none">
          <input
            ...
            disabled={disabled}
            className="rounded border-slate-700 bg-slate-950 text-cyan-500 focus:ring-cyan-500 focus:ring-offset-slate-900"
          />
          <span>Positivos</span>
        </label>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
        <div>
          ...
          <select
            ...
            disabled={disabled}
            className="w-full px-2.5 py-1.5 bg-slate-950 border border-slate-700 rounded-lg text-xs text-slate-200 focus:outline-none focus:ring-1 focus:ring-cyan-500"
          >
